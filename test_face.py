...
from pyvino.model.object_detection.face_detector import FaceDetector
...
def main():
    ...
    #model = FaceDetector(model_fp='FP16')
    model = FaceDetector()
    ...
    cv2.imwrite('test_face.jpg', new_frame)
    print('Save to test_face.jpg')
