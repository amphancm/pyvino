...
from pyvino.model.human_pose_estimation.head_pose_estimator import HeadPoseDetector
...
def main():
    ...
    cv2.imwrite('test_headpose.jpg', new_frame)
    print('Save to test_headpose.jpg')
